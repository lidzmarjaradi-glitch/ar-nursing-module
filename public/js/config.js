...
const modelConfig = {
    ...
    // Draco-compressed GLBs used where they are smaller than the original .bin.
    // Texture-heavy models (eye, tongue, etc.) keep scene.gltf because embedding
    // large textures into GLB would increase total download size.
    ...
    // Texture-heavy — keep scene.gltf (GLB would embed textures, increasing size)
