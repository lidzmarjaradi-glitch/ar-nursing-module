...
const modelConfig = {
    ...
    liver: { type: 'external', path: '/models/liver/scene_draco.glb' },
    stomach: { type: 'external', path: '/models/stomach/scene_draco.glb' },
    eye: { type: 'external', path: '/models/eye/scene_draco.glb' },
    tooth: { type: 'external', path: '/models/tooth/scene_draco.glb' },
    ...
    knee_joint: { type: 'external', path: '/models/knee_joint/scene_draco.glb' },
    shoulder_joint: { type: 'external', path: '/models/shoulder_joint/scene_draco.glb' },
    ...
    muscular_system: { type: 'external', path: '/models/muscular_system/scene_draco.glb' },
    esophagus: { type: 'external', path: '/models/esophagus/scene_draco.glb' },
    ...
    tongue: { type: 'external', path: '/models/tongue/scene_draco.glb' },
    larynx: { type: 'external', path: '/models/larynx/scene_draco.glb' },
    diaphragm: { type: 'external', path: '/models/diaphragm/scene_draco.glb' },
    ...
    inner_ear: { type: 'external', path: '/models/inner_ear/scene_draco.glb' },
    ...
    ear: { type: 'external', path: '/models/ear/scene_draco.glb' },
    blood_cells: { type: 'external', path: '/models/blood_cells/scene_draco.glb' },
    human_cell: { type: 'external', path: '/models/human_cell/scene_draco.glb' },
    dna: { type: 'external', path: '/models/dna/scene_draco.glb' },
    iv_setup: { type: 'external', path: '/models/iv_setup/scene_draco.glb' },
